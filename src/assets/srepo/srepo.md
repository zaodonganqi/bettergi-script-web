...
> 由 BetterGI 在本地已经下载的脚本仓库中复制对应的脚本文件至你的 [User](https://www.bettergi.com/feats/append/files.html) 文件夹下。  
...
> 你也可以通过查看[本地文件](https://www.bettergi.com/feats/append/files.html)中的Repos的说明了解更多。

![更新仓库](img/update_repo.png)
...
![地图追踪](img/script_list1.png)![js脚本](img/script_list2.png)
...
![文件列表](img/map_detail.png)

#### 5.3 文件详情

点击对应条目的`详情`按钮后，会出现以下弹窗，你可以查看该项的具体信息。

![文件详情](img/map_file_detail.png)
...
![评论按钮](img/comment.png)

![本地评论弹窗](img/local_giscus.png)

![在线评论弹窗](img/online_giscus.png)
